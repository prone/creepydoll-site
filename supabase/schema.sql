...
create table if not exists public.runs (
  ...
  minis       integer not null check (minis between 0 and 16),
  parts       integer not null check (parts between 0 and 7),
  untouched   integer not null check (untouched between 0 and 7),
